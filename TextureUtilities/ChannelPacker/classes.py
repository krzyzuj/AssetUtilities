...
class SetEntry(TypedDict):
    ...
    tex_types: Dict[str, List[str]] # Recognized texture map types grouped by texture set.
...
class TextureData(TypedDict):
    tex_set_name: str # Texture set name after stripping type/size suffixes.
...
class ValidModeEntry:
    ...
    maps_for_mode: TextureMapCollection # Required maps for this set.
